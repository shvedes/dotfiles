...
local language = {
    ['eng'] = {
        welcome = '{\\fs18\\1c&H0&\\3c&HB3DCEB&}Drop files or URLs to play.',  -- this text appears when mpv starts
        off = 'OFF',
        na = 'n/a',
        none = 'none',
        video = 'Video',
...
local osc_styles = {
    ...
    SeekbarBg = '{\\blur0\\bord0\\1c&H666F7C&}',
    SeekbarFg = '{\\blur1\\bord1\\1c&H3B9AD9&}',
    VolumebarBg = '{\\blur0\\bord0\\1c&H666F7C&}',
    VolumebarFg = '{\\blur1\\bord1\\1c&H3B9AD9&}',
    Ctrl1 = '{\\blur0\\bord0\\1c&HB3DCEB&\\3c&HB3DCEB&\\fs36\\fnmaterial-design-iconic-font}',
    Ctrl2 = '{\\blur0\\bord0\\1c&HB3DCEB&\\3c&HB3DCEB&\\fs24\\fnmaterial-design-iconic-font}',
    Ctrl3 = '{\\blur0\\bord0\\1c&HB3DCEB&\\3c&HB3DCEB&\\fs24\\fnmaterial-design-iconic-font}',
    Time = '{\\blur0\\bord0\\1c&HB3DCEB&\\3c&H000000&\\fs17\\fn' .. user_opts.font .. '}',
    Tooltip = '{\\blur1\\bord0.5\\1c&H94AEBC0000&\\fs18\\fn' .. user_opts.font .. '}',
    Title = '{\\blur1\\bord0.5\\1c&HC9F2FB&\\3c&H0\\fs48\\q2\\fn' .. user_opts.font .. '}',
    WinCtrl = '{\\blur1\\bord0.5\\1c&HB3DCEB&\\3c&H0\\fs20\\fnmpv-osd-symbols}',
...
local state = {
    ...
    active_element = 0,                   -- nil = none, 0 = background, 1+ = see elements[]
...
function show_logo()
    ...
    ass:append('{\\1c&H383B3F&\\3c&H0&\\3a&H60&\\blur1\\bord0.5}')
    ass:draw_start()
